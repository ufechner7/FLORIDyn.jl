...
1. Create a copy of an existing YAML file in the data folder. Give it a good name. The file `turbine-specs.yaml` does not have to be copied. If you need additional turbine definitions, just add them to this file.
