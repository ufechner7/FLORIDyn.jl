...
- `dir::Union{Nothing, Matrix{Float64}, WindDirMatrix}`: Optional wind direction matrix or covariance data.
...
@with_kw mutable struct Wind
    ...
    dir::Union{Nothing, Matrix{Float64}, WindDirMatrix} = nothing
