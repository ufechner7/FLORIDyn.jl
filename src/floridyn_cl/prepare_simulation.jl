...
function prepareSimulation(Wind, Con, paramFLORIDyn, paramFLORIS, turbProp, Sim, Vis)
    loadDataWarnings = String[]

    # ========== WIND: Velocity ==========
    vel_file_dir = joinpath(Sim.PathToSim, "Data")
    ...
    return T, Wind, Sim, Con, paramFLORIS, Vis
end
