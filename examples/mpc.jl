...
MAX_STEPS = 20      # maximum number black-box evaluations for NOMAD optimizer
USE_TGC = false
USE_STEP = false
...
if (! SIMULATE) && ((isfile(data_file) && !GROUP_CONTROL) || (isfile(data_file_group_control) && GROUP_CONTROL))
    ...
    if GROUP_CONTROL
        ...
        if GROUPS == 8
            x0 = [1.325, 1.472, 1.33, 1.292, 1.32, 0.0, -0.0, 1.91, 1.92, 1.99, 0.87, 0.0]
        elseif GROUPS == 4
        ...
        elseif GROUPS == 12
            ...
            x0 = [1.4, 1.7, 1.35, 1.28, 1.35, 0.010165, 0.029492, 0.019167, 1.88922, 0.0181, 2.115, 1.38954, 1.8827, 1.14561, 1.00147, 0.9951]
        else
